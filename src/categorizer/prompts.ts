...
const WRITE_EDIT_TEMPLATE = [
  ...
  "  3. ALWAYS PLAN FIRST: before your first write/edit, call \`create_plan\` and break the work",
  "     into ordered steps. Route each attachment to ONLY the steps that need it (a mockup belongs",
