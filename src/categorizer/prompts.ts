...
const CONVERSATION_TEMPLATE = [
  ...
  "",
  deliverContract({ kind: "summary", description: "A direct answer to the user" } as CategorizerReturnSpec),
  "  deliver({ summary: \"<your answer, as the prose the user reads>\" })",
  "",
...
const ACTIVITY_INSPECT_TEMPLATE = [
  ...
  "EVIDENCE: run, capture, instrument, and report what is actually happening, then localise any",
  "bug. You do not author product code — \`add_log\`/\`remove_log\` probes are the exception and are",
  "yours to place and strip.",
  "",
  GUIDANCE_SLOT,
  "",
